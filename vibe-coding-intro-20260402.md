...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 340" font-family="'Hiragino Sans', 'Noto Sans JP', sans-serif" style="width: 100%; max-height: 420px;">
  ...
  <text x="200" y="133" text-anchor="middle" font-size="14" fill="#d1d5db">▼</text>
  ...
  <text x="200" y="193" text-anchor="middle" font-size="14" fill="#d1d5db">▼</text>
  ...
  <text x="200" y="253" text-anchor="middle" font-size="14" fill="#d1d5db">▼</text>
  ...
  <text x="600" y="133" text-anchor="middle" font-size="14" fill="#028090">▼</text>
  ...
  <text x="600" y="193" text-anchor="middle" font-size="14" fill="#00A896">▼</text>
  ...
  <text x="600" y="253" text-anchor="middle" font-size="14" fill="#02C39A">▼</text>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 24px;">
  ...
  <div style="background: #f9fafb; border-radius: 12px; padding: 20px;">
    ...
    <p style="font-size: 20px; color: #1f2937; font-weight: 600;">英語</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 280" font-family="'Hiragino Sans', 'Noto Sans JP', sans-serif" style="width: 100%; max-height: 360px;">
  ...
  <text x="191" y="135" text-anchor="middle" font-size="16" fill="#028090">▶</text>
  ...
  <text x="393" y="135" text-anchor="middle" font-size="16" fill="#00A896">▶</text>
  ...
  <text x="595" y="135" text-anchor="middle" font-size="16" fill="#02C39A">▶</text>
  ...
  <text x="494" y="228" text-anchor="middle" font-size="14" fill="#028090">▲</text>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: center;">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 340" font-family="'Hiragino Sans', 'Noto Sans JP', sans-serif" style="width: 100%; max-height: 380px;">
    ...
    <text x="390" y="103" text-anchor="middle" font-size="14" fill="#028090">▼</text>
    ...
    <text x="333" y="225" text-anchor="middle" font-size="14" fill="#00A896">◀</text>
    ...
    <text x="90" y="172" text-anchor="middle" font-size="14" fill="#02C39A">▲</text>
    ...
    <text x="141" y="49" text-anchor="middle" font-size="14" fill="#028090">▶</text>
